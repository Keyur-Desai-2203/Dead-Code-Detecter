    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="card w-100">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                        <ul>
                            <li>This script will scan your all controllers.</li>
            ...
            <div class="row">
                <div class="card w-100">
                    <div class="card-header">
                        <h5 class="m-0">Scan Controllers</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <button class="btn btn-primary" id="scanButton">Scan Controllers</button>
                        <div id="progress"></div>
                    </div>
                </div>
            </div>
            <div class="row" id="unusedFunctionsSection" style="display: none;">
                <div class="card w-100">
                    <div class="card-header">
                        <h5 class="m-0">Un-used Controller Functions</h5>
                    </div>
                    <div class="card-body">
                        <div id="results"></div>
                    </div>
